...
BUSINESS_TERMS = [
    ...
    ("term.deposit_transaction_amount", "Deposit Transaction Amount", "metric", "Total posted commercial deposit transaction amount over a selected period.", "SUM(fact_deposit_transaction.amount)", "fact_deposit_transaction", "amount", True, "Deposit Operations", "Commercial Deposits"),
    ("term.transaction_channel", "Transaction Channel", "dimension", "Channel used to originate or process a posted commercial deposit transaction.", None, "fact_deposit_transaction", "channel", True, "Deposit Operations", "Commercial Deposits"),
    ("term.customer_name", "Customer Name", "attribute", "Commercial customer legal or relationship name. This attribute is restricted and cannot be used in generated analytical SQL.", None, "dim_customer", "customer_name", True, "Commercial Data Governance", "Commercial Banking"),
...
METRICS = [
    ...
    ("metric.total_deposit_transaction_amount", "Total Deposit Transaction Amount", "Total posted commercial deposit transaction amount.", "SUM(fdt.amount)", "SUM", "fact_deposit_transaction", "amount,transaction_date,account_id", "latest_complete_month", True, "Commercial Deposits"),
...
DIMENSIONS = [
    ...
    ("dimension.transaction_channel", "Transaction Channel", "Channel used to originate or process a commercial deposit transaction.", "fact_deposit_transaction", "channel", "ACH, Wire, Branch, Digital, Lockbox, Check", True, "Commercial Deposits"),
    ("dimension.transaction_type", "Transaction Type", "Commercial deposit transaction type.", "fact_deposit_transaction", "transaction_type", "ACH Credit, ACH Debit, Wire In, Wire Out, Check Deposit", True, "Commercial Deposits"),
    ("dimension.transaction_direction", "Transaction Direction", "Credit or debit direction for a commercial deposit transaction.", "fact_deposit_transaction", "direction", "Credit, Debit", True, "Commercial Deposits"),
    ("dimension.customer_name", "Customer Name", "Commercial customer legal or relationship name. Restricted for governed analytical SQL.", "dim_customer", "customer_name", "Summit Manufacturing LLC, Pioneer Health Partners Inc.", True, "Commercial Banking"),
...
LINEAGE = [
    ...
    ("lineage.deposit_transaction_channel", "Deposit Operations Platform", "Posted Deposit Transactions", "fact_deposit_transaction", "channel", "Transaction channels are standardized from deposit operation event codes.", "Daily", "Deposit Operations"),
...
SYNONYMS = [
    ...
    ("syn.total_deposit_transaction_amount", "total deposit transaction amount", "metric", "metric.total_deposit_transaction_amount", 0.97, "Direct transaction amount metric synonym."),
    ("syn.deposit_transaction_amount", "deposit transaction amount", "metric", "metric.total_deposit_transaction_amount", 0.96, "Direct transaction amount metric synonym."),
    ("syn.transaction_amount", "transaction amount", "metric", "metric.total_deposit_transaction_amount", 0.92, "Posted transaction amount synonym."),
    ...
    ("syn.transaction_channel", "transaction channel", "dimension", "dimension.transaction_channel", 0.96, "Direct transaction channel synonym."),
    ("syn.channel", "channel", "dimension", "dimension.transaction_channel", 0.92, "Default deposit transaction channel grouping."),
    ("syn.transaction_type", "transaction type", "dimension", "dimension.transaction_type", 0.95, "Deposit transaction type grouping."),
    ("syn.transaction_direction", "transaction direction", "dimension", "dimension.transaction_direction", 0.94, "Deposit transaction direction grouping."),
    ("syn.customer_name", "customer name", "dimension", "dimension.customer_name", 0.97, "Restricted customer name attribute."),
    ("syn.customer_names", "customer names", "dimension", "dimension.customer_name", 0.97, "Restricted customer name attribute."),
